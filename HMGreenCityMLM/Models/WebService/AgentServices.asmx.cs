...
using HMGreenCityMLM.DAL;
using HMGreenCityMLM.Models.DAL;
using System;
...
namespace HMGreenCityMLM.Models.WebService
{
    /// <summary>
        ...
        public List<AgentModel> GetGeneology(string memID, string sessionid)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                tree.Add(new AgentModel
                {
                    ...
                    LastTopupdate = dr["LastTopupdate"].ToString(),
       ...
       // string Login
        ...
        public List<AgentModel> GetUserFirst(string memID)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                model.LastTopupdate = dr["LastTopupdate"].ToString();
